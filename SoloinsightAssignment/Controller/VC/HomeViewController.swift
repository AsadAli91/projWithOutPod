...
//    var totalCellInSectionTwo = 3
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UINib(nibName: String(describing: AllDevicesTableViewCell.self), bundle: Bundle.main), forCellReuseIdentifier: AllDevicesTableViewCell.className)
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if section == 0{
            ...
            return totalCellInSectionTwo + userInputs.count
            // totalCellInSectionTwo
        }
        return 0
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0{
            ...
            else if indexPath.item == (totalCellInSectionTwo + userInputs.count) - 1 { // last cell  2
                let cell = tableView.dequeueReusableCell(withIdentifier: "LastCellTableViewCell") as! LastCellTableViewCell
                return cell
            }else if indexPath.item == (totalCellInSectionTwo + userInputs.count) - 2 { // second last  1
